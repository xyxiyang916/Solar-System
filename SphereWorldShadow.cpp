...
CSphereWorldShadow::CSphereWorldShadow()
{
}
...
// context. 
void CSphereWorldShadow::SetupRC()
{


	glDisable(GL_FOG);//停用用雾效果模拟
...
void CSphereWorldShadow::DrawGround(void)
{
...
void CSphereWorldShadow::DrawInhabitants(GLint nShadow)
{
...
void CSphereWorldShadow::RenderScene(void)
{
...
void CSphereWorldShadow::SpecialKeys(int key, int x, int y)
{
	if (key == GLUT_KEY_UP)
...
// resized or moved)
void CSphereWorldShadow::TimerFunction(int value)
{
...
void CSphereWorldShadow::ChangeSize(int w, int h)
{
	GLfloat fAspect;
	...
	gluPerspective(15.0f, fAspect, 1.0f, 50.0f);
